#ifndef CGameBoyBios_H
#define CGameBoyBios_H

namespace CGameBoyBios {

// 256 bytes 0x0000->0x0100
const ushort gbSize = 256;
...
// 256 bytes 0x0000->0x0100, 1792 bytes (0x0200->0x0900)
const ushort cgbSize = 2048;

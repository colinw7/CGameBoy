...
// 0 xx      DJNZ offset    STOP             Meaning unknown
#ifndef GAMEBOY_Z80
void
CZ80::
...
void
CZ80::
f_ld_p_fc_a(CZ80OpData *opData)
{
  opData->z80->setByte(0xff00 + opData->z80->getC(), opData->z80->getA());
}
#endif

// F2         JP P,word     LD A,(FF00+C)         Load A from (FF00+C)
#ifndef GAMEBOY_Z80
void
CZ80::
...
void
CZ80::
f_ld_a_p_fc(CZ80OpData *opData)
{
  opData->z80->setA(opData->z80->getByte(0xff00 + opData->z80->getC()));
}
#endif
...
void
CZ80::
f_ld_a_p_hld(CZ80OpData *opData)
{
  opData->z80->setA(opData->z80->getPHL());
...
void
CZ80::
f_ld_a_p_hli(CZ80OpData *opData)
{
  opData->z80->setA(opData->z80->getPHL());
...
void
CZ80::
f_ld_p_hld_a(CZ80OpData *opData)
{
  opData->z80->setPHL(opData->z80->getA());
...
void
CZ80::
f_ld_p_hli_a(CZ80OpData *opData)
{
  opData->z80->setPHL(opData->z80->getA());
...
void
CZ80::
f_add_sp_n(CZ80OpData *opData)
{
  opData->z80->setSP(opData->z80->getSP() + opData->getSByte2());
}
#endif
...
void
CZ80::
f_ld_p_fn_a(CZ80OpData *opData)
{
  opData->z80->setByte(0xff00 + opData->getUByte1(), opData->z80->getA());
}
#endif
...
void
CZ80::
f_ld_a_p_fn(CZ80OpData *opData)
{
  opData->z80->setA(opData->z80->getByte(0xff00 + opData->getUByte2()));
}
#endif

// F8 xx      RET M          LD HL SP+offset   Load HL with SP + signed offset
#ifndef GAMEBOY_Z80
void
CZ80::
...
void
CZ80::
f_ld_hl_sp_n(CZ80OpData *opData)
{
  opData->z80->setHL(opData->z80->getWord(opData->z80->getSP() + opData->getSByte2()));
}
#endif

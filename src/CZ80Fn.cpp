...
void
CZ80::
f_ld_p_fc_a(CZ80OpData *op_data)
{
  op_data->z80->setByte(0xff00 + op_data->z80->getC(), op_data->z80->getA());
}
#endif
...
void
CZ80::
f_ld_a_p_fc(CZ80OpData *op_data)
{
  op_data->z80->setA(op_data->z80->getByte(0xff00 + op_data->z80->getC()));
}
#endif
...
void
CZ80::
f_ld_a_p_hld(CZ80OpData *op_data)
{
  op_data->z80->setA(op_data->z80->getPHL());
...
void
CZ80::
f_ld_a_p_hli(CZ80OpData *op_data)
{
  op_data->z80->setA(op_data->z80->getPHL());
...
void
CZ80::
f_ld_p_hld_a(CZ80OpData *op_data)
{
  op_data->z80->setPHL(op_data->z80->getA());
...
void
CZ80::
f_ld_p_hli_a(CZ80OpData *op_data)
{
  op_data->z80->setPHL(op_data->z80->getA());
...
void
CZ80::
f_add_sp_n(CZ80OpData *op_data)
{
  op_data->z80->setSP(op_data->z80->getSP() + op_data->getSByte2());
}
#endif
...
void
CZ80::
f_ld_p_fn_a(CZ80OpData *op_data)
{
  op_data->z80->setByte(0xff00 + op_data->getUByte1(), op_data->z80->getA());
}
#endif
...
void
CZ80::
f_ld_a_p_fn(CZ80OpData *op_data)
{
  op_data->z80->setA(op_data->z80->getByte(0xff00 + op_data->getUByte2()));
}
#endif
